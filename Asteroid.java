	...
	public class Asteroid{
		...
		public static void main(String[] args) {
			...
			while(true){
				...
				if(existsf){
					spaceShip.spaceship.speed_x += (spaceShip.center.getX() - spaceShip.spaceship.pos_x)*Stlvl/1000;  
					spaceShip.spaceship.speed_y += (spaceShip.center.getY() - spaceShip.spaceship.pos_y)*Stlvl/1000;  
				}
				...
				gameHandler.destroyDetect(Stlvl,asteroids, bullets, spaceShip);
				if(existsf){
					gameHandler.CheckCrashGrav(spaceShip, spaceShip.spaceship, spaceShip.center);
				}
